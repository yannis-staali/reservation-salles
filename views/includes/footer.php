<footer class="footer">
    <section class="foot_block1">
        <a class="foot_element1" href="#">WORK</a>
        <a class="foot_element2" href="#">CONTACT</a>
        <a class="foot_element3" href="#">NEWS</a>
        <a class="foot_element4" href="#">SHOP</a>
    </section>
    <section class="foot_block2">
        <p>YAYA-PRODUCTION™</p>
    </section>
